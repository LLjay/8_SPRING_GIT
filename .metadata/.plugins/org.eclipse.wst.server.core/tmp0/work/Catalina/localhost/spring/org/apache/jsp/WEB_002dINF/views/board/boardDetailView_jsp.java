 ...
 * Generated at: 2024-04-19 03:45:40 UTC
...
public final class boardDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td colspan=\"4\"><p style=\"height:150px;\">게시글내용입니다</p></td>\r\n");
      out.write("                </tr>\r\n");
      out.write("            </table>\r\n");
      out.write("            <br>\r\n");
      out.write("\r\n");
      ...
      out.write("                    drawReplyList(result);\r\n");
      out.write("                })\r\n");
      out.write("            })\r\n");
      out.write("\r\n");
      out.write("            // 서버에서는 간단하게 데이터만 만들어주면 프론트에서 다 풀어 헤쳐서 형변환 자유롭게 그리고 구성하면 됨\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("            // ajax 호출 함수를 따로 뺀 것\r\n");
      out.write("            // 댓글 목록 가져오기\r\n");
      out.write("            // 이 함수는 댓글 목록 가져오기 하나의 기능만 가져오면 좋음\r\n");
      out.write("            // 만약 필터를 적용하지 않고 가져오면 그때는 이렇게 쓰면 되고\r\n");
      out.write("            // 필터가 있다면 컨디션에 따라 보내는 정보가 달라짐\r\n");
      out.write("            function getReplyList(data, callback){\r\n");
      out.write("                $.ajax({\r\n");
      out.write("                    url: 'rlist.bo',\r\n");
      out.write("                    // data : {bno : ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${b.boardNo}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("}, // 페이지 로딩 시 있는 정보이므로 EL이 먼저 보드 넘버로 바꿔줄 것\r\n");
      out.write("                    data : data, // 이렇게 해야 외부의 영향을 내부에서 받지 않음\r\n");
      out.write("                    success: function(result) {\r\n");
      out.write("                        callback(result)\r\n");
      out.write("                    },\r\n");
      out.write("                    error: function(){\r\n");
      out.write("                        console.log(\"댓글 요청 ajax 실패\");\r\n");
      out.write("                    }\r\n");
      out.write("                })\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            // 1. innerHTML로 가져오는 방법 : 단순히 보여주기 위한 view 작성 시\r\n");
      ...
      out.write("            //         str += `<tr>\r\n");
      out.write("            //                     <th>`+reply.replyWriter+`</th>\r\n");
      ...
      out.write("            // }\r\n");
      out.write("            // 단 이 방식은 중간에 onclick, 버튼 클릭 등을 넣기 힘듦\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("            // 2. document element : 이벤트를 넣는 뷰를 작성하고 싶을 때\r\n");
      out.write("            // tr 자체를 document로 만든다?\r\n");
      out.write("            function drawReplyList(replyList){\r\n");
      out.write("                for (let reply of replyList){\r\n");
      out.write("                    const replyRow = document.createElement('tr');\r\n");
      out.write("                    // 객체로 만들어서 가져와준 것\r\n");
      out.write("                    replyRow.innerHTML = `<th>`+reply.replyWriter+`</th>\r\n");
      out.write("                                            <td>`+reply.replyContent+`</td>\r\n");
      out.write("                                            <td>`+reply.createDate+`</td>`\r\n");
      out.write("                    replyBody.appendChild(replyRow);\r\n");
      out.write("\r\n");
      out.write("                    replyRow.onclick = function(){\r\n");
      out.write("                        console.log(reply);\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("                // 온클릭 했을 때 그 댓글 지우고 싶으면 그 온클릭에 댓글 번호를 넣으면 됨\r\n");
      out.write("                // reply, notice 등 여러 아이템을 범용 가능한 ui여야 함\r\n");
      out.write("                // 들어갈 데이터까지 받아서 주면 ui는 화면만 그려줄 수 있는 코드가 됨\r\n");
      out.write("            \r\n");
      out.write("                // 강사님 해당 페이지 코드 참고할 것\r\n");
      out.write("\r\n");
      out.write("                // 데이터만 넘겨주면 ui는 알아서 그려줄게 -> 라이브러리\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        </script>\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/boardDetailView.jsp(65,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("                <a class=\"btn btn-primary\" onclick=\"\">수정하기</a>\r\n");
          out.write("                <a class=\"btn btn-danger\" onclick=\"\">삭제하기</a>\r\n");
          out.write("               ");
  ...
  private boolean _jspx_meth_c_005fwhen_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/boardDetailView.jsp(83,17) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
