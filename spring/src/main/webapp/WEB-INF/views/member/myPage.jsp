			...
			<form action="update.me" method="post">
				<div class="form-group">
					<label for="userId">* ID : </label> <input type="text"
						class="form-control" id="userId" value="${loginUser.userId }"
						name="userId" readonly> <br> <label for="userName">*
					...
					<label for="email"> &nbsp; Email : </label> <input type="text"
						...
						name="email"> <br> <label for="age"> &nbsp;
						Age : </label> <input type="number" class="form-control" id="age"
						value="${loginUser.age }" name="age"> <br> <label
						for="phone"> &nbsp; Phone : </label> <input type="tel"
						class="form-control" id="phone" value="${loginUser.phone }"
						name="phone"> <br> <label for="address">
						&nbsp; Address : </label> <input type="text" class="form-control"
						id="address" value="${loginUser.address }" name="address">
					<br> <label for=""> &nbsp; Gender : </label> &nbsp;&nbsp; <input
						type="radio" id="Male" value="M" name="gender"> <label
				...
				<script>
                	$(function(){
                		...
                		} // 자바스크립트로 하면 겟바이로 가져와서 속성 바꿔주면 됨 
                	})
                </script>
				...
				<form action="delete.me" method="post">
					...
					<div class="modal-body">
						...
						<br> <label for="userPwd" class="mr-sm-2">Password :
							...
							placeholder="Enter Password" id="userPwd" name=""> <br>
					</div>
					<!-- Modal footer -->
