...
//	@Pointcut("execution(*com.kh.etc..controller.*.*(..))") // aop에서 많이 쓰는 어노테이션
...
//	@Before("target(com.kh.etc.board.controller.BoardController)") // 이 메소드에 하겠다고 join point를 지정해줄 수 있음, 이걸 할 때 하겠다
